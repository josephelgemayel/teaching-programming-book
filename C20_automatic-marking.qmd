...
![CodeRunner configuration.](/chapters/images/C20_Figure2.png "CodeRunner configuration."){#fig-config fig-alt="A screenshot of the CodeRunner question configuration panel in Moodle, displaying various settings such as question type, precheck, check and penalty options, customisation, template, and support files." width=60%}
...
![Answer form.](/chapters/images/C20_Figure3.png "Answer form."){#fig-answer fig-alt="A screenshot of the student-facing answer form in CodeRunner, showing a programming answer input box along with Precheck and Check buttons beneath it." width=50%}
...
This can also be significantly more complex; see the Moodle XML file [`CodeRunnerConstruct.xml`](/chapters/resources/PLACEHOLDER.docx) for an example. [TODO: upload the actual file]
